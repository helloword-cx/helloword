...
<body>
    ...
    <c:if test="${userName !=null }">
	 ...
	 <!--  -->
	 <div class="mian">
	  <div class="content" style="font-size: 20px;background: #fa8f00;height: 40px;color: white;font-weight: bold;padding-left: 5px;text-align: center;line-height:40px">意见箱</div>
	  <div class="matter">
        <div class="content2">
             	 <form action="advice_yijian.do" method="post" id="pinglunform">
	                 ...
	                 <!-- 一条说说 -->
	                 	<c:forEach items="${pagers.datas}" var="data" varStatus="l">
							...
							<div class="vm bold c999">
		                   		...
		                   		<a class="c4095ce" target="_blank" href="#">${data.sendUser.userName}</a>	
		                   		<span>${data.createTime}</span>
		                   	</div>
	                        <p class="recBox"> ${data.content}</p>
    ...
    <!-- 分页 -->
      ...
      <pg:pager  url="${ctx}/advice_advice.do" maxIndexPages="5" items="${pagers.total}"  maxPageItems="15" export="curPage=pageNumber" >
		<pg:last>  
