...
public class SayMoodServiceImpl implements SayMoodService{
	...
	public Pager<SayMood> findAllphotosById(int userId) {
		// TODO Auto-generated method stub
		return sayMoodDao.findAllphotosById(userId);
	}

	@Override
	public void del(int sayId) {
		SayMood s = sayMoodDao.load(sayId);
		s.setIsDelete(1);
		sayMoodDao.update(s);
	}
	...
	public List<SayMood> findSYusay() {
		// TODO Auto-generated method stub
		return sayMoodDao.findSYusay();
	}

	@Override
	public List<SayMood> findBYsay() {
		// TODO Auto-generated method stub
		return sayMoodDao.findBYsay();
	}
