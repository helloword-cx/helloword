...
<form action="news_add.do" method="post" class="definewidth m20" id="hh">
<table class="table table-bordered table-hover definewidth m10">
   <tr>
        <td width="10%" class="tableleft">标题</td>
        <td height="50"><input type="text" style="height:"30px"; width:"200px" name="title" id="title" value=""/></td>
    </tr>
</table>
