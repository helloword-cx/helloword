...
<body>
<form action="jf_add.do" method="post" class="definewidth m20" id="hh">
...
<!-- private int type;
    ...
    <tr>
        ...
        <td><input type="text" name="miaoshu" id="name"/></td>
    </tr>
    <tr>
        <td width="10%" class="tableleft">分数</td>
        <td><input type="text" name="fenshu" id="fenshu"/></td>
    </tr>
    <tr>
        ...
        <td>
           <select id ='' name="type"> 
	              ...
	              <option value="2">登陆</option>
	               <option value="3">发说说</option>
	                <option value="4">上传照片</option>
	                 <option value="5">好友评论</option>
	                  <option value="6">添加好友</option>
	                   <option value="7">投意见</option>
